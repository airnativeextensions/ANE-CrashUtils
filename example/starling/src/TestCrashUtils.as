...
package
{
	import com.distriqt.test.crashutils.Main;
	...
	/**	
	 * Sample application for using the CrashUtils Native Extension
	 */
	public class TestCrashUtils extends Sprite
	{
		////////////////////////////////////////////////////////
		//	CONSTANTS
		//
		 ...
		 *  Constructor
		 */
		public function TestCrashUtils()
		{
			super();
			if(this.stage)
			{
