...
package com.distriqt.test.crashutils
{
	...
	public class Main extends Sprite implements ILogger
	{
		...
		private var _tests:CrashUtilsTests;
		...
		private function createUI():void
		{
			...
			_tests = new CrashUtilsTests( this );


			addAction( "Force Crash", _tests.forceCrash );
			addAction( "Get Exit Reasons", _tests.getHistoricalProcessExitReasons );
			addAction( "App Not Responding", _tests.appNotResponding );
